...
namespace Common.Helpers
{
    ...
    {
        public static string GetErrorMsg(Exception e, int back = 1)
        {
            StackTrace stackTrace = new StackTrace();
            StackFrame stackFrame = stackTrace.GetFrame(back); // 1 means the previous frame in the call stack.
        ...
        public static string GetErrorMsg(mException e)
        {
            ...
            return $"{className}::{functionName}() LINE:{line} {e.Message}";
            //return $"Class: {className}, Function: {functionName}, Line: {line}";
